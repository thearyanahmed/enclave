...
const CORE_MIGRATIONS: &[(&str, &str)] = &[
    (
        ...
        include_str!("../../migrations/postgres/core/20241220000001_create_users_table.sql"),
    ),
    (
    ...
    (
        ...
        include_str!(
            "../../migrations/postgres/core/20241220000004_create_email_verification_tokens_table.sql"
        ),
    ),
    (
        "20241222000001_add_token_metadata_fields",
        include_str!("../../migrations/postgres/core/20241222000001_add_token_metadata_fields.sql"),
    ),
];
...
const TEAMS_MIGRATIONS: &[(&str, &str)] = &[
    (
        ...
        include_str!("../../migrations/postgres/teams/20241227000002_create_teams_table.sql"),
    ),
    (
    ...
    (
        ...
        include_str!(
            "../../migrations/postgres/teams/20241227000005_create_team_member_permissions_table.sql"
        ),
    ),
    (
