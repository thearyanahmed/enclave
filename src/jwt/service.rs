...
impl JwtService {
    ...
    pub fn encode(&self, user_id: i64) -> Result<String, AuthError> {
        self.encode_access_token(user_id)
    }

    pub fn encode_access_token(&self, user_id: i64) -> Result<String, AuthError> {
        let now = Utc::now();
    ...
    pub fn encode_refresh_token(&self, user_id: i64) -> Result<String, AuthError> {
        let now = Utc::now();
    ...
    pub fn create_token_pair(&self, user_id: i64) -> Result<TokenPair, AuthError> {
    ...
    pub fn validate(&self, token: &str) -> Result<i64, AuthError> {
    ...
    pub fn validate_any(&self, token: &str) -> Result<i64, AuthError> {
        let claims = self.decode(token)?;
        claims.user_id()
    }
